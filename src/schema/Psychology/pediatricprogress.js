  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            "Auditory hallucinations (assess carefully — distinguish from imagination/play)",
          value: "auditory",
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            "Limited — impulsive decisions without considering consequences",
          value: "limited",
        },
        {
    ...
    },
    {
      ...
      options: [
        {
          label:
            "Caregiver's description of child's current state matches clinician observation",
          value: "matches",
        },
        {
        ...
        {
          label:
            "Significant discrepancy between caregiver report and observed behaviour (document)",
          value: "discrepancy",
        },
        {
    ...
    },
    {
      ...
      label:
        "Describe discrepancy between caregiver report and observed behaviour",
      type: "input",
      showIf: {
