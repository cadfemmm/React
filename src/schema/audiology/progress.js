      ...
      "fields": [
        ...
        },
        {
          ...
          "options": [
            {
              "label": "Home Exercise",
              "values": "home_exercise"
            },
            {
              "label": "In Office Training",
              "values": "office_training"
            },
            {
              "label": "Both",
              "values": "both"
          ...
          "options": [
            {
              ...
              "values": "hearing_aid_trial"
            },
            {
              "label": "Hearing Aid Fitting",
              "values": "hearing_aid_fitting"
            },
            {
              "label": "Hearing Aid Verification",
              "values": "hearing_aid_verification"
            },
            {
              "label": "Hearing Aid Validation",
              "values": "hearing_aid_validation"
            },
            {
              "label": "Auditory Training",
              "values": "auditory_training"
            }
          ]
        },
        {
