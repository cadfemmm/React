  ...
  sections: [
    {
      fields: [
        ...
        },
        {
          ...
          label: "Prescription",
          showIf: { field: "spectacles_use", equals: "yes" },
        },
        {
          type: "radio",
        ...
        },
        {
          ...
          showIf: { field: "show_questionnaires", equals: true },
          options: [
            {
  ...
  sections: [
    {
      fields: [
        ...
        },
        {
          ...
          type: "checkbox-group",
          options: [{ label: "Entrance Test", value: "entrance_test" }],
        },
        {
          type: "subheading",
          label: "Visual Acuity",
        ...
        },
        {
          ...
          cols: [
            {
              type: "single-select",
              options: ["PERRL", "Anisocoria R>L", "Anisocoria L>R"],
            },
            {
              type: "single-select",
              options: ["PERRL", "Anisocoria R>L", "Anisocoria L>R"],
