...
const BinocularVisionAssessment = lazy(
  () => import("../features/Optometry/BinocularVisionAssessment"),
);
const RefractionAssessment = lazy(
  () => import("../features/Optometry/RefractionAssessment"),
);
const VisionAssessment = lazy(
  () => import("../features/Optometry/VisionAssessment"),
);
const OcularHealthAssessment = lazy(
  () => import("../features/Optometry/OcularHealthAssessment"),
);
const SpecialDiagnosticAssessment = lazy(
  () => import("../features/Optometry/SpecialDiagnostic"),
);
const LVQoLForm = lazy(
  () => import("../features/Optometry/LowVisionQualityAssessment"),
);
const BrainVisionInjury = lazy(
  () => import("../features/Optometry/BrainVisionInjury"),
);
const VisualFunctionForm = lazy(
  () => import("../features/Optometry/VisionFunctionalAssessment"),
);
const BVDAssessment = lazy(
  () => import("../features/Optometry/BvdqAssessment"),
);
const LowVisionAssessment = lazy(
  () => import("../features/Optometry/LowVisionAssessment"),
);
      ...
      (name, value) => {
        setValues((v) => {
          ...
          saveTimer.current = setTimeout(() => {
            if (formDataId) {
              api
                .patch(API_URL.ASSESSMENT + `data/${formDataId}/`, {
                  data: next,
                })
                .catch(() => {});
            }
...
const BinocularVisionAdapter = makeAdapter(
  BinocularVisionAssessment,
  "optometry_assessments_active",
  "BINOCULAR_VISION",
);
const RefractionAdapter = makeAdapter(
  RefractionAssessment,
  "optometry_assessments_active",
  "REFRACTION",
);
const VisionAdapter = makeAdapter(
  VisionAssessment,
  "optometry_assessments_active",
  "VISION_DRIVING",
);
const OcularHealthAdapter = makeAdapter(
  OcularHealthAssessment,
  "optometry_assessments_active",
  "OCULAR_HEALTH",
);
const SpecialDiagnosticAdapter = makeAdapter(
  SpecialDiagnosticAssessment,
  "optometry_assessments_active",
  "SPECIAL_DIAGNOSTIC",
);
const LVQoLAdapter = makeAdapter(
  LVQoLForm,
  "optometry_assessments_active",
  "LVQOL",
);
const BrainVisionAdapter = makeAdapter(
  BrainVisionInjury,
  "optometry_assessments_active",
  "BRAIN_VISION",
);
const VisualFunctionAdapter = makeAdapter(
  VisualFunctionForm,
  "optometry_assessments_active",
  "VISUAL_FUNCTION",
);
const BVDQAdapter = makeAdapter(
  BVDAssessment,
  "optometry_assessments_active",
  "BVDQ",
);
const LowVisionAdapter = makeAdapter(
  LowVisionAssessment,
  "low_vision_assessment_active",
  "LOW_VISION_ASSESSMENT",
);
const BVQuestionnaireAdapter = makeAdapter(
  BVQuestionnaire,
  "optometry_assessments_active",
  "BV_QUESTIONNAIRE",
);
