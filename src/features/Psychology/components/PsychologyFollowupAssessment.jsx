...
// Schema
import PSYCHO_FOLLOW_SCHEMA from "../../../schema/psychology/followup";
...
export default function PsychologyAssessment({
  ...
  const schemaMap = {
    subjective: PSYCHO_FOLLOW_SCHEMA.SUBJECTIVE,
    objective: PSYCHO_FOLLOW_SCHEMA.OBJECTIVE,
    assessment: PSYCHO_FOLLOW_SCHEMA.ASSESSMENT,
    plan: PSYCHO_FOLLOW_SCHEMA.PLAN,
  };
