...
const FIELDS = [
  ...
  ratingField("grips", "Grips"),
  ratingField("manipulate", "Manipulate"),

  ratingField("coordination_eyehand", "Coordination"),
  ratingField("coordination_bilateral", "Coordination"),

  ratingField("lifting", "Lifting"),
  ratingField("transport", "Transport"),

  ratingField("sitting", "Sitting"),
  ...
  ratingField("attention", "Attention"),

  ratingField("memory", "Memory"),

  ratingField("perception", "Perception"),

  ratingField("consciousness", "Consciousness"),

  ratingField("visual", "Visual"),

  ratingField("touch", "Touch"),

  ratingField("positioning1", "Positioning"),
  ratingField("positioning2", "Positioning"),
...
export default function DesignIntegrated({ patient, onBacK, onSubmit
 }) {
  ...
  const schema = {
    ...
    title: "Design Integrated Functional Training",
