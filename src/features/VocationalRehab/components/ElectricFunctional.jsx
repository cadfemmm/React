...
const PAIN_SCORE_FIELDS = [
  ...
  PainScoreField("d315_p", "d315 - Non verbal message (P)"),
  PainScoreField("d315_c", "d315 - Non verbal message (C)"),

  PainScoreField("d350_p", "d350 - Conversation (P)"),
  PainScoreField("d350_c", "d350 - Conversation (C)"),

  PainScoreField("d410_p", "d410 - Changing body position (P)"),
  PainScoreField("d410_c", "d410 - Changing body position (C)"),
  ...
  PainScoreField("d465_p", "d465 - Using equipment (P)"),
  PainScoreField("d465_c", "d465 - Using equipment (C)"),

  PainScoreField("d470_p", "d470 - Interpersonal interaction (P)"),
  PainScoreField("d470_c", "d470 - Interpersonal interaction (C)")
];
...
/* ══════════════════════════════════════════════════════════
   MAIN COMPONENT
══════════════════════════════════════════════════════════ */
export default function ElectricFunctional({ patient, onBack }) {
