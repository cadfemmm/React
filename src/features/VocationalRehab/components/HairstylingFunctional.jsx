...
const PAIN_SCORE_FIELDS = [
  ...
  PainScoreField("d240_p", "d240 - Handling stress and other psychological demands(P)"),
  PainScoreField("d240_c", "d240 - Handling stress and other psychological demands(C)"),
 ...
 PainScoreField("d315_p", "d315 - Communicating with -receiving nonverbal message(P)"),
  ...
  //   PainScoreField("d75_p", "d475 - Driving(P)"),
  // PainScoreField("d475_c", "d465 - Driving(C)"),
...
/* ══════════════════════════════════════════════════════════
   MAIN COMPONENT
══════════════════════════════════════════════════════════ */
export default function HairstylingFunctionak({ patient, onBack }) {
