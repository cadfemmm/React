...
const PAIN_SCORE_FIELDS = [
  ...
  PainScoreField("d360_p", "d360 - Using Communicating Devices and Technique (P)"),
  PainScoreField("d360_c", "d360 - Using Communicating Devices and Technique (C)"),
  ...
  PainScoreField("d840_p", "d840 - Apprenticeship(P)"),
  PainScoreField("d840_c", "d840 - Apprenticeship(C)")
];
...
/* ══════════════════════════════════════════════════════════
   MAIN COMPONENT
══════════════════════════════════════════════════════════ */
export default function OfficeadminAssessmnet({ patient, onBack }) {
