...
export default function UrbanfarmingIntegrated({ patient, onBack,onSubmit }) {
...
const handleAction = (action) => {
  if (action === "back") {
    if (onBack) {
      onBack(); // 👈 this is your navigation back
    } else {
  ...
  return (
    ...
    <div>
      ...
      <CommonFormBuilder
        ...
        layout="nested" onAction={handleAction}   // ✅ IMPORTANT FIX
