...
ratingField(
  ...
  ratingField(
    "sustained_hand_steadying",
    "Sustained Hand Steadying"
  ),
...
export default function ElectronicIntegrated({ patient, onBack, onSubmit }) {
  ...
  const schema = {
    ...
    title: "Electronic Integrated Functional Training",
