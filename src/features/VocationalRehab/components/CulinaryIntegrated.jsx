...
const FIELDS = [
    ...
    ratingField("position", "Position"),
  ratingField("stabilisation", "Stabilisation"),
  ratingField("reach", "Reach"),
  ratingField("bend", "Bend"),
  ratingField("grip", "Grip / Pinch"),
  ratingField("dexterity", "Dexterity"),
  ratingField("coordination", "Coordination"),
  ratingField("pushpull", "Push / Pull"),
  ratingField("lifting", "Lifting"),
  ratingField("walking", "Walking"),
  ratingField("carrying", "Carrying"),
  ratingField("manipulation", "Manipulation"),
  ratingField("endurance", "Endurance"),

  ratingField("attention1", "Attention (Sustained)"),
  ratingField("attention2", "Attention (Selective)"),
  ratingField("attention3", "Attention (Divided)"),

  ratingField("memory1", "Memory (Short-Term)"),
  ratingField("memory2", "Memory (Long-Term)"),

  ratingField("planning", "Executive - Planning"),
  ratingField("problem", "Executive - Problem Solving"),
  ratingField("decision", "Executive - Decision Making"),
  ratingField("judgment", "Executive - Judgment"),

  ratingField("sequencing", "Sequencing"),
  ratingField("initiation", "Initiation"),
  ratingField("insight", "Insight & Awareness"),
  ratingField("time", "Time Management"),
  ratingField("visual", "Visual Function")
...
export default function CulinaryIntegrated({ patient, onBack, onSubmit }) {
  ...
  const schema = {
    ...
    title: "Culinary Integrated Functional Training",
